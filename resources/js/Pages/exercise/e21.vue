<template>
  <div class="p-4 space-y-4">
    <div class="text-xl font-semibold">BOM物料表</div>
      ...
      <div>BOM物料表规则数位说明：       
        ...
        <span class="r2" :class="{ active: hoverClass === 'r2' }">年份编号</span>+ 
        <span class="r3" :class="{ active: hoverClass === 'r3' }">供应商编号</span>+ 
        <span class="r4" :class="{ active: hoverClass === 'r4' }">序号</span>+ 
      </div>
    <div>
      BOM编号查询：
      <input type="search" name="bomSearch" id="search" placeholder="🔍" class=" rounded-lg">
    </div>
